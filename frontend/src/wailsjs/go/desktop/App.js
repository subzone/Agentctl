...
export function ActivateLicense(arg1) {
  return window['go']['desktop']['App']['ActivateLicense'](arg1);
}
...
export function GetEntitlement() {
  return window['go']['desktop']['App']['GetEntitlement']();
}
...
export function InstallPackage(arg1) {
  return window['go']['desktop']['App']['InstallPackage'](arg1);
}
...
export function ListPackageOffers() {
  return window['go']['desktop']['App']['ListPackageOffers']();
}
