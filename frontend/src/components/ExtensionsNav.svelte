<script>
  ...
  export let active = 'tools';
</script>

<div class="ext-nav">
  <button class:active={active === 'tools'} on:click={() => dispatch('select', 'tools')}>
    <span class="ico">🛠</span> Tools
  </button>
  <button class:active={active === 'skills'} on:click={() => dispatch('select', 'skills')}>
